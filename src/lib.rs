// src/lib.rs
/*
 * Core library for UltraGradient
 */
...
#[derive(Debug)]
pub struct UltraGradientProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraGradientProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraGradient processing");
    
    let mut processor = UltraGradientProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraGradientProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraGradientProcessor::new(false);
